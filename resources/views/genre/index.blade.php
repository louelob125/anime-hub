            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-100">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('genre.create') }}" class="inline-block px-6 py-2 text-base font-medium leading-6 text-center text-white uppercase transition bg-green-500 rounded shadow ripple hover:shadow-lg hover:bg-green-700 focus:outline-none">
                            Add Genre
                        </a>
                    </div>
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-gray-800 divide-y divide-gray-700">
                            ...
                            <tr id="genre-{{ $genre->id }}" class="hover:bg-gray-700">
                    ...
                    <script>
                        window.onload = function() {
                            ...
                            let row;
                            if (highlight) {
                                row = document.getElementById('genre-' + highlight);
                                if (row) {
