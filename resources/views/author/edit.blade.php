                        ...
                        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            ...
                            <form method="POST" action="{{ route('author.update', $author) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ $author->name }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full" required>
                                </div>

                                <!-- Pseudonym -->
                                <div class="mb-4">
                                    <label for="pseudonym" class="block text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Pseudonym') }}</label>
                                    <input id="pseudonym" name="pseudonym" type="text" value="{{ $author->pseudonym }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full">
                                </div>

                                <!-- Bio -->
                                <div class="mb-4">
                                    <label for="bio" class="block text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Bio') }}</label>
                                    <textarea id="bio" name="bio" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full">{{ $author->bio }}</textarea>
                                </div>

                                <!-- Ratings -->
                                <div class="mb-4">
                                    <label for="ratings" class="block text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Ratings') }}</label>
                                    <input id="ratings" name="ratings" type="number" step="0.01" value="{{ $author->ratings }}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full">
                                </div>
